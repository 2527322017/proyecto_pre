            ...
            <div class="col-md-12 col-sm-12">
              <div class="x_panel tile">
                <div class="x_content">
                 ...
                 Estadísticas de reclamos y sugerencias registrados por mes. Con los botones inferiores puedes cambiar la vista del gráfico.
                  </p>
            ...
            <div class="col-md-6 col-sm-6">
                <div class="x_panel tile">
                  <div class="x_content">
                    ...
                    <p class="highcharts-description">
                      El presente gráfico se puede observar los casos registrados por área de salud.
                    </p>
                    </figure>
                  </div>
                </div>
            ...
            <div class="col-md-6 col-sm-6">
                <div class="x_panel tile">
                  <div class="x_content">
                    ...
                    <p class="highcharts-description">
                      El presente gráfico se puede observar los casos registrados por tipo.
                    </p>
                    </figure>
                  </div>
                </div>
            ...
            <div class="col-md-6 col-sm-6">
                <div class="x_panel tile">
                  <div class="x_content">
                    ...
                    <p class="highcharts-description">
                      El presente gráfico se puede observar los casos registrados por género.
                    </p>
                    </figure>
                  </div>
                </div>
            ...
            <div class="col-md-6 col-sm-6">
                <div class="x_panel tile">
                  <div class="x_content">
                    ...
                    <p class="highcharts-description">
                      El presente gráfico se puede observar los casos registrados por tipo de cliente.
                    </p>
                    </figure>
                  </div>
                </div>
            ...
            <div class="col-md-12 col-sm-12">
              <div class="x_panel tile">
                <div class="x_content">
                  ...
                  <p class="highcharts-description">
                 Estadísticas de reclamos y sugerencias por estado. Con los botones inferiores puedes cambiar la vista del gráfico.
                  </p>
