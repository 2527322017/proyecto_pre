...
class Tipo_resolucion_model extends CI_Model
{
    private $table_model = 'tipo_resolucion';
    private $table_primary_key = 'id_tipo_res';
    private $table_relation = 'registro_caso';
    private $table_relation_key = 'tipo_res_id';
